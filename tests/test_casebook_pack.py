"""Regression checks for the radian-model-serve-probe casebook."""
...
from casebook.harness import assert_expected, radian_model_serve_probe_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(radian_model_serve_probe_summary(), assert_expected())
